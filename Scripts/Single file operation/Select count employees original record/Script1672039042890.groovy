...
String countEmployeeQuery = 'SELECT count(*) FROM `employees`'

ResultSet countResultSet = sqlStatement.executeQuery(countEmployeeQuery)

countResultSet.next()

int employeeCount = countResultSet.getInt(1)

int employeeCountOnOriginalSampleData = 300024

WS.verifyEqual(employeeCount, employeeCountOnOriginalSampleData)
