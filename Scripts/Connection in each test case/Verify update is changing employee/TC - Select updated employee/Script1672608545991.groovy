...
String employeeQuery = "SELECT `birth_date` FROM `employees` WHERE emp_no=$empNo"

ResultSet employeeResultSet = sqlStatement.executeQuery(employeeQuery)

employeeResultSet.next()

String birthDate = employeeResultSet.getString('birth_date')

WS.verifyMatch(birthDate, newBirthDate, false)
