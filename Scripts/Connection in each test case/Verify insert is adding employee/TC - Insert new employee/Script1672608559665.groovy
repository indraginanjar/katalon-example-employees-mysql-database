...
import com.kms.katalon.util.CryptoUtil.CrytoInfo as CrytoInfo
...
String newEmployeeInsert = "INSERT INTO `employees` (`emp_no`, `birth_date`, `first_name`, `last_name`, `gender`, `hire_date`) VALUES ($empNo, '$birthDate', '$firstName', '$lastName', '$gender', '$hireDate')"

int affectedRowCount = sqlStatement.executeUpdate(newEmployeeInsert)

WS.verifyEqual(affectedRowCount, 1)
